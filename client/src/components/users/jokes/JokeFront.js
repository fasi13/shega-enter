          ...
          <div className="jokeHeaderContainer">
            <div className="content-center">
              ...
              <div className="listContainer">
                <a className="list1" href="#selectedJokTitle">
                  የተመረጡ ቀልዶች
                </a>
                <a className="list2" href="#familyJokTitle">
                  የቤተሰብ ቀልዶች
                </a>
                <a className="list3" href="#workJokTitle">
                  የስራ ቦታ ቀልዶች
                </a>
              </div>
              <h4 id="landingShegajok" className="landingShegaJok">
                Shega Entertainment
              </h4>
            </div>
          </div>
          ...
          <div className="jokeCards">
            <Container>
              <div className="selectedJokContainer">
                <h2
                  className="selectedJokTitle"
                  id="selectedJokTitle"
                >{`${this.state.titleS}`}</h2>
                <div className="selectedJokes">
                  <div className="selectedBody">
                    <h2 className="selJokMsg">
                      <img src={icon} alt="" className="imogy" align="left" />
                      <p>{`${this.state.jokeSA}`}</p>
                      <img src={men} alt="" className="imogy" align="left" />
                      <p>{`${this.state.jokeSB}`}</p>
                      <img
                        src={icon}
                        alt=""
                        className="imogy"
                        align="left"
                      />{" "}
                      <p>{`${this.state.jokeSC}`}</p>
                      <img src={men} alt="" className="imogy" align="left" />
                      <p>{`${this.state.jokeSD}`}</p>
                    </h2>
                  </div>
                  <div>
                    <Button className="prevSel" onClick={this.prevSelectHandle}>
                      <i className="fa fa-backward" aria-hidden="true"></i>
                    </Button>
                  </div>
                  <div>
                    <Button className="nextSel" onClick={this.nextSelectHandle}>
              ...
              <div className="familyJokContainer">
                <h2
                  className="familyJokTitle"
                  id="familyJokTitle"
                >{`${this.state.titleF}`}</h2>
                <div className="familyJokes">
                  <div className="familyBody">
                    <h2 className="familyMsg">
                      <img src={icon} alt="" className="imogy" align="left" />
                      <p>{`${this.state.jokeFA}`}</p>
                      <img src={men} alt="" className="imogy" align="left" />
                      <p>{`${this.state.jokeFB}`}</p>
                      <img src={icon} alt="" className="imogy" align="left" />
                      <p>{`${this.state.jokeFC}`}</p>
                      <img src={men} alt="" className="imogy" align="left" />
                      <p>{`${this.state.jokeFD}`}</p>
                    </h2>
                  </div>
                  <div>
                    <Button className="prevFam" onClick={this.prevFamHandle}>
                      <i className="fa fa-backward" aria-hidden="true"></i>
                    </Button>
                  </div>
                  <div>
                    <Button className="nextFam" onClick={this.nextFamHandle}>
                      <i className="fa fa-forward" aria-hidden="true"></i>
                    </Button>
                  </div>
                </div>
              ...
              <div className="workJokContainer">
                <h2
                  className="workJokTitle"
                  id="workJokTitle"
                >{`${this.state.titleW}`}</h2>
                <div className="workJokes">
                  <div className="workBody">
                    <h2 className="workMsg">
                      <img src={icon} alt="" className="imogy" align="left" />
                      <p>{`${this.state.jokeWA}`}</p>
                      <img src={men} alt="" className="imogy" align="left" />
                      <p>{`${this.state.jokeWB}`}</p>
                      <img src={icon} alt="" className="imogy" align="left" />
                      <p>{`${this.state.jokeWC}`}</p>
                      <img src={men} alt="" className="imogy" align="left" />
                      <p>{`${this.state.jokeWD}`}</p>
                    </h2>
                  </div>
                  <div>
                    <Button className="prevWork" onClick={this.prevWorkHandle}>
                      <i className="fa fa-backward" aria-hidden="true"></i>
                    </Button>
                  </div>
                  <div>
                    <Button className="nextWork" onClick={this.nextWorkHandle}>
                      <i className="fa fa-forward" aria-hidden="true"></i>
                    </Button>
                  </div>
                </div>
