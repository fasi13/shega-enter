...
import { getIntrgrammar } from "../../../../actions/gramAction";
          ...
          <div className="languageTitle">
            <Row>
              <Col xs="4" className="levelInd">
                <h1 className="begginerLevel">Intermediate Level</h1>
              </Col>
              <Col xs="8">
...
Intermediate.propTypes = {
  getIntrVocabulary: PropTypes.func.isRequired,
  getIntrgrammar: PropTypes.func.isRequired,
...
export default connect(mapStateToProps, { getIntrVocabulary, getIntrgrammar })(
  Intermediate
);
