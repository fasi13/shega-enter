...
import { getAdvanVocabulary } from "../../../../actions/vocabAction";
import { getAdvangrammar } from "../../../../actions/gramAction";
          ...
          <div className="languageTitle">
            <Row>
              <Col xs="4" className="levelInd">
                <h1 className="begginerLevel">Advanced Level</h1>
              </Col>
              <Col xs="8">
...
Advanced.propTypes = {
  getAdvanVocabulary: PropTypes.func.isRequired,
  getAdvangrammar: PropTypes.func.isRequired,
