...
import { deleteAdvanExercise } from "../../../actions/exerciseAction";
import { toast, ToastContainer } from "react-toastify";
import spinner from "../../users/layout/Spinner2.gif";

class LangAdvancedExercise extends Component {
  constructor(props) {
    super(props);
  ...
  onDeleteRecord(record) {
    this.props.deleteAdvanExercise(record);
  }
          ...
          <div id="page-content-wrapper">
            <div className="container-fluid">
              ...
              <h1 className="mt-2 text-primary">
                Advanced Level <br /> Exercise List
              </h1>
...
LangAdvancedExercise.propTypes = {
  deleteAdvanExercise: PropTypes.func.isRequired,
...
export default connect(mapStateToProps, { deleteAdvanExercise })(
  LangAdvancedExercise
);
