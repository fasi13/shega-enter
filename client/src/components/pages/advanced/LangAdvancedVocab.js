...
import { deleteAdvanVocabulary } from "../../../actions/vocabAction";
import { toast, ToastContainer } from "react-toastify";
import spinner from "../../users/layout/Spinner2.gif";

class LangAdvancedVocab extends Component {
  constructor(props) {
    super(props);
  ...
  onDeleteRecord(record) {
    this.props.deleteAdvanVocabulary(record);
  }
          ...
          <div id="page-content-wrapper">
            <div className="container-fluid">
              ...
              <h1 className="mt-2 text-primary">
                Advanced Level <br /> Vocabulary List
              </h1>
...
LangAdvancedVocab.propTypes = {
  deleteAdvanVocabulary: PropTypes.func.isRequired,
...
export default connect(mapStateToProps, { deleteAdvanVocabulary })(
  LangAdvancedVocab
);
