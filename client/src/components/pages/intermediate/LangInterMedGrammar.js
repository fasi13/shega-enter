...
import { deleteIntrGrammar } from "../../../actions/gramAction";
import { toast, ToastContainer } from "react-toastify";
import spinner from "../../users/layout/Spinner2.gif";

class LangInterMedGrammar extends Component {
  constructor(props) {
    super(props);
  ...
  onDeleteRecord(record) {
    this.props.deleteIntrGrammar(record);
  }
...
LangInterMedGrammar.propTypes = {
  deleteIntrGrammar: PropTypes.func.isRequired,
...
export default connect(mapStateToProps, { deleteIntrGrammar })(
  LangInterMedGrammar
);
