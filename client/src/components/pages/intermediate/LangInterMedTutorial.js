...
import { deleteIntrTutorialVid } from "../../../actions/tutorialVedio";
import { toast, ToastContainer } from "react-toastify";
import spinner from "../../users/layout/Spinner2.gif";

class LangInterMedTutorial extends Component {
  constructor(props) {
    super(props);
  ...
  onDeleteRecord(record) {
    this.props.deleteIntrTutorialVid(record);
  }
          ...
          <div id="page-content-wrapper">
            <div className="container-fluid">
              ...
              <h1 className="mt-2 text-primary">
                Intermediate Level <br /> Tutorial Video List
              </h1>
...
LangInterMedTutorial.propTypes = {
  deleteIntrTutorialVid: PropTypes.func.isRequired,
...
export default connect(mapStateToProps, { deleteIntrTutorialVid })(
  LangInterMedTutorial
);
