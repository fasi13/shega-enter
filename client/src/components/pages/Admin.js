                ...
                <div className="d-flex" id="wrapper">
                    ...
                    <div id="page-content-wrapper">
                        <div className="container-fluid">
                            ...
                            <button className="btn btn-outline-primary float-right mt-3 mr-2" data-toggle="modal" data-target="#add-admin-modal"><FontAwesomeIcon icon={faPlus}/> Add Admin</button>
