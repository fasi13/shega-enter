...
import { addFamilyJoke } from "../../actions/addFamilyJoke";
...
class AddFamilyJoke extends React.Component {
  constructor() {
    super();
    this.state = {
      type: "",
  ...
  onFamilyJokeAdd = (e) => {
    ...
    this.props.addFamilyJoke(newFamilyJoke, this.props.history);
  };
  ...
  render() {
    ...
    return (
      <div>
        <div className="modal fade" id="add-family-joke" data-reset="true">
          <div className="modal-dialog modal-lg">
            <div className="modal-content">
              ...
              <div className="modal-body">
                <form noValidate onSubmit={this.onFamilyJokeAdd} id="add-admin">
...
AddFamilyJoke.propTypes = {
  addFamilyJoke: PropTypes.func.isRequired,
...
export default connect(mapStateToProps, { addFamilyJoke })(
  withRouter(AddFamilyJoke)
);
