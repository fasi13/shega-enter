...
import { addOfficeJoke } from "../../actions/addOfficeJoke";
...
class AddOfficeJoke extends React.Component {
  constructor() {
    super();
    this.state = {
      type: "",
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (
      ...
      nextProps.auth.officeJoke !== undefined &&
      nextProps.auth.officeJoke.data !== undefined &&
      nextProps.auth.officeJoke.data.message !== undefined
    ) {
      $("#add-selected-joke").modal("hide");
      toast(nextProps.auth.officeJoke.data.message, {
  ...
  onOfficeJokeAdd = (e) => {
    ...
    this.props.addOfficeJoke(newOfficeJoke, this.props.history);
  };
  ...
  render() {
    ...
    return (
      <div>
        <div className="modal fade" id="add-office-joke" data-reset="true">
          <div className="modal-dialog modal-lg">
            <div className="modal-content">
              ...
              <div className="modal-body">
                <form noValidate onSubmit={this.onOfficeJokeAdd} id="add-admin">
...
AddOfficeJoke.propTypes = {
  addOfficeJoke: PropTypes.func.isRequired,
...
export default connect(mapStateToProps, { addOfficeJoke })(
  withRouter(AddOfficeJoke)
);
