...
import { updateAdvanVocabulary } from "../../../actions/vocabAction";
import { updateAdvanGrammar } from "../../../actions/gramAction";
import { updateAdvanTutorialVid } from "../../../actions/tutorialVedio";
import { updateAdvanExercise } from "../../../actions/exerciseAction";
import $ from "jquery";
...
class LanguageUpdateModal extends React.Component {
  ...
  onVocabularyUpdate = (e) => {
    ...
    this.props.updateAdvanVocabulary(newData);
  ...
  onGrammarUpdate = (e) => {
    ...
    this.props.updateAdvanGrammar(newData);
  ...
  onVedioLinkUpdate = (e) => {
    ...
    this.props.updateAdvanTutorialVid(newData);
  ...
  onExerciseUpdate = (e) => {
    ...
    this.props.updateAdvanExercise(newData);
...
LanguageUpdateModal.propTypes = {
  updateAdvanVocabulary: PropTypes.func.isRequired,
  updateAdvanGrammar: PropTypes.func.isRequired,
  updateAdvanTutorialVid: PropTypes.func.isRequired,
  updateAdvanExercise: PropTypes.func.isRequired,
};
...
export default connect(mapStateToProps, {
  updateAdvanVocabulary,
  updateAdvanGrammar,
  updateAdvanTutorialVid,
  updateAdvanExercise,
})(LanguageUpdateModal);
